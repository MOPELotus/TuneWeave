...
当前统计：`pending=385`、`partial=7`、`implemented=6`、`verified=6`。只有所有条目都达到 `verified`，或以证据明确标为上游已失效，网易云阶段才算完成。
...
| `digitalAlbum_detail` | `/digitalAlbum/detail` | `pending` | — |
