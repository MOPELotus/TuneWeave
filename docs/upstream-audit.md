...
| QQ 音乐 | `L-1124/QQMusicApi` | `1b0aae0db3ee6876b3a77b8d1ce3057b4b3c9cd5` | 2026-07-22 | GPL-3.0-or-later |
...
- 网易云从 `35d1c61` 更新到 `41bd6d8`，公开模块仍为 416。`song_url_v1` 新增仅在 `level=sky` 生效的 `immerseType=c51|ste|aac`，缺省 `c51`；覆盖账本已把该分支登记为待补齐，不能继续把固定 `c51` 当作完整输入。
