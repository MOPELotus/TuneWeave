...
mod tests {
    ...
    fn similar_resource_capabilities_use_stable_discovery_names() {
        ...
        assert_eq!(
            serde_json::to_value(Capability::RelatedVideos)
                .expect("serialize related video capability"),
            serde_json::json!("related_videos")
        );
        assert_eq!(
            serde_json::to_value(Capability::TrackVersions)
                .expect("serialize track version capability"),
            serde_json::json!("track_versions")
        );
        assert_eq!(
    ...
    fn radio_station_capabilities_use_stable_discovery_names() {
        ...
        assert_eq!(
            serde_json::to_value(Capability::VideoSubtitles)
                .expect("serialize video subtitles capability"),
            serde_json::json!("video_subtitles")
        );
        assert_eq!(
            serde_json::to_value(Capability::VideoPlaybackManifest)
                .expect("serialize video playback manifest capability"),
            serde_json::json!("video_playback_manifest")
        );
        assert_eq!(
            serde_json::to_value(Capability::VideoAudioStream)
                .expect("serialize video audio stream capability"),
            serde_json::json!("video_audio_stream")
        );
        assert_eq!(
            serde_json::to_value(Capability::VideoTrackStream)
                .expect("serialize video track stream capability"),
            serde_json::json!("video_track_stream")
        );
        assert_eq!(
        ...
        assert_eq!(
            serde_json::to_value(Capability::AccountDislikeWrite)
                .expect("serialize account dislike write capability"),
            serde_json::json!("account_dislike_write")
        );
        assert_eq!(
        ...
        assert_eq!(
            serde_json::to_value(Capability::ListeningRightsStatus).expect("serialize capability"),
            serde_json::json!("listening_rights_status")
        );
        assert_eq!(
