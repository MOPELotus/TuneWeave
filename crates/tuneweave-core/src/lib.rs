...
pub use model::{
    ...
    Playlist, ProviderDescriptor, Quality, RadioCatalogOption, RadioStation, RadioStationCursor,
    ...
    SearchTrendingEntry, SearchTrendingList, SearchTrendingRequest, SearchVariant, StreamOutcome,
