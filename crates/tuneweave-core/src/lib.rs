...
pub use model::{
    ...
    PodcastTaxonomy, PodcastTaxonomyKind, PodcastTaxonomyRequest, ProviderDescriptor, Quality,
    ...
    TrialWindow, User, UserProfile, UserProfileBackend, Video, VideoCatalogOption, VideoDetail,
