...
Basic 优先覆盖普通音乐 App 的搜索、展示、播放/VIP 权益、登录、个人音乐库、MV、云盘、播客和底层协议；网易云剩余工作中，云盘完整读写、下载和播放链路优先于播客目录及节目播放。网易云 Basic 与可导入任意平台歌单、混合添加并播放任意平台资源的 Uni Playlist 已收口；QQ Basic 已接入持久 Android 设备/QIMEI/会话、歌曲到彩铃的十类统一搜索及强类型 selectors、移动端搜索补全、独立快速搜索、热词目录、逐项 `song_type` 的 ID/MID 混合批量详情、Web 富单曲详情、普通/逐字/翻译/罗马音/助唱标注歌词、CDN 调度、48 种普通/加密/试听/特殊/彩铃文件规格、统一播放/无损下载/302/跨平台回退，以及完整登录、多账户、创建/收藏个人歌单目录、歌单详情、完整歌曲分页、当前账户/任意用户喜欢歌曲与收藏专辑/MV、分组榜单、榜单歌曲分页、六区新专辑和地区/性别/流派/首字母歌手目录。QQ 高频目录阶段已经收口，当前转入其余个人音乐库；最终全量要求不变，完整顺序、范围和定期上游检查规则见 [docs/implementation-plan.md](docs/implementation-plan.md)。
